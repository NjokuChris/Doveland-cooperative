    ...
    <img class="animation__shake" src="{{ asset('img/dvllogo.png') }}" alt="AdminLTELogo" height="60" width="60">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <!-- Cart -->
                <li class="nav-item">
                    <a style="color: red" class="nav-link" href="{{route('user.cart.index')}}" role="button">
                        <i  class="fas fa-shopping-cart"></i>
                     {{--   Cart[{{ CartController::count(); }}] --}}
                        Cart[{{App\Http\Controllers\user\CartController::count()}}]
                    </a>
                </li>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('/home') }}" class="brand-link">
                <img src="{{ asset('img/dvllogo.png') }}" alt="AdminLTE Logo"
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('statement_search_all') }}" class="nav-link">
                                    <i class=" far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('user.withdrawers.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Track cash Withdrawers
                               ...
                               <li class="nav-item">
                                    <a href="{{ route('statement_acc_search') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Statement of Account</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user.comm.create') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Request Commodities</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user') }}" class="nav-link">
            ...
            {{--             <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('CommSearch')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Comodity Request</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('commperiod.index') }}" class="nav-link">
                                        <i class=" far fa-circle nav-icon"></i>
                                        <p>Commodity Period</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('loans_schedule_search') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Loans Schedule Report</p>
                                    </a>
                                </li>
                                <li class="nav-item">
