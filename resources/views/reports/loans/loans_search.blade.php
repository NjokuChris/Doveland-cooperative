...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Search Loans Report.</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/home') }}">Home</a></li>
                        <li class="breadcrumb-item">Cooperative Loans</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Cooperative Loans Report Search Form</h3>
                </div>
                <form method="post" action="{{ route('loans_report')}}">
                    ...
                    <div class="card-body">
                            ...
                            <div>
                                <div class="col-md-1">
                                    <div class="">
                                        ...
                                        <input type="hidden" readonly id="member_id" name="member_no">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="approval_stage_id">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Loans ID</label>
                                    <input type="text" class="form-control" name="loans_id">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Loan Amount (Greater Than)</label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Loans Type</label>
                                    <select class="form-control select2" name="loans_type_id">
                                        <option value="" selected>Select Loans Type</option>
