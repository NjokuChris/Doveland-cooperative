    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-default">
                ...
                <form method="post" action="{{ route('receipts_report')}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div>
                                <div class="col-md-4">
                                    <div class="">
                                        <label class="">Receipts ID</label>
                                        <input type="text" name="receipts_id">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Receipts Amount</label>
