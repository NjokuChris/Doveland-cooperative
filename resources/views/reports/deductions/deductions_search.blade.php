...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Cooperative Monthly Deductions</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Monthly Deduction Search Form.</h3>
                </div>
                <form method="get" action="{{ route('deductions_report') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Deduction Type</label>
                                        <select class="form-control select2" id="year_id" style="width: 100%;" name="salary_group_id">
                                            <option value="">Select Deduction Type</option>
                                            @foreach ($salary_group as $p)
                                                <option value="{{$p->salary_group_id}}">{{$p->salary_group}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
...
<script type=text/javascript>
    ...
    if(yearID){
      $.ajax({
        type:"GET",
        url:"{{url('getPayrollMonth1')}}?year_id="+yearID,
