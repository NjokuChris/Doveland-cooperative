                ...
                <form method="post" action="{{ route('loans.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="tenor" min="0" class="form-control" required name="tenor">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Intrest</label>
                                    <input type="number" id="interest_rate" min="0" class="form-control" placeholder="%" required name="interest_rate">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Monthly Payment</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" id="interest_amount" class="form-control" name="interestamount" readonly>
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            ...
            function calc_total() {
               ...
               // console.log(amount1)
                ...
                monthly_deduction = amount1 / tenor
