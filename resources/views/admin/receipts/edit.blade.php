    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-default">
                ...
                <form method="POST" action="{{route('receipt.update', $receipts->id)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                            ...
                            <div>
                                <div class="col-md-5">
                                    <div class="input-field form-group">
                                        ...
                                        <input type="text" id="autocomplete-input" class="autocomplete" value="{{$receipts->Subaccount->subaccount_name}}">
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="col-md-2">
                                    <div class="">
                                        ...
                                        <input type="text" readonly id="customer_id" name='customer_id' readonly value="{{$receipts->subaccountcode}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="amount_paid" value="{{$receipts->amount_paid}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Paid By</label>
                                    <input type="text" class="form-control"  name="paid_by" value="{{$receipts->paid_by}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="pay_method" disabled style="width: 100%;" name="method_pay">
                                        <option value="">Select Method of Payment</option>
                                        @foreach ($pay_method as $p)
                                            <option value="{{$p->id}}"
                                                @if ($p->id == $receipts->method_pay) selected

                                                @endif>{{$p->pay_method}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" id="accounts" name="account_no">
                                        ...
                                        @foreach ($accounts as $a)
                                            <option value="{{$a->id}}"
                                                @if ($a->id == $receipts->account_no) selected

                                                @endif>{{$a->account_name}}</option>
                                        @endforeach
                                    </select>
                                    </select>
                                </div>
                        ...
                        <div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter Receipts Description..." name="naration">{{$receipts->naration}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
