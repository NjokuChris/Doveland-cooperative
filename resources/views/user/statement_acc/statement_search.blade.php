                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly value="{{ Auth::user()->name }}" class="form-control" name="member_name" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating"></label>
                                    <input type="text" readonly value="{{Auth::user()->member_id}}" class="form-control" name="member_id" required>
                                </div>
                            </div>
                        </div>
