                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" name="firstName" required value="{{$member->firstName}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="bmd-label-floating">Sur Name</label>
                            <input type="text" readonly class="form-control" name="surName" required value="{{$member->surName}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="bmd-label-floating">Other Names</label>
                            <input type="text" readonly class="form-control" name="middleName" value="{{$member->middleName}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Company</label>
                            <input type="text" readonly class="form-control" name="company" value="@if ($member->company != null)
                            {{$member->company->company_name}}
                            @endif ">
                            <input type="hidden" readonly class="form-control" name="company_id" value="{{$member->company_id}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="bmd-label-floating">employee No.</label>
                            <input type="text" readonly class="form-control" name="employee_no" value="{{$member->employee_no}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="email" readonly class="form-control" name="email" value="{{$member->email}}">
                        </div>
                    </div>
                </div>
                <div class="row">
